...
<head>
    ...
    <script type="text/javascript" src="/local/frontend/local/catalog-kitchen/catalog-kitchen.js"></script>
    ...
    <section>
        <div class="container">
            <div class="flex-container">
                <div class="block-25">
                    <div class="block-category" style="background-image: url('/local/images/main/каталог_кухни.jpg')">
                        <div class="blackout"></div>
                        <a href="#" class="link-absolute"></a>
                        <div class="category__block-title category__title_align-center">
                            <span class="category__title category__title_small-text">Материалы</span>
                        </div>
                    </div>
                </div>
                <div class="block-25">
                    <div class="block-category" style="background-image: url('/local/images/main/каталог_кухни.jpg')">
                        ...
                        <a href="#" class="link-absolute"></a>
                        <div class="category__block-title category__title_align-center">
                            <span class="category__title category__title_small-text">Мебель<span>
                        </div>
                    </div>
                </div>
                <div class="block-25">
...
<footer>
    <div class="footer-block">
        <div class="container">
            <div class="flex-container">
                <div class="col-desk-50 d-tab-none  d-none">
                    <div class="footer_title"><a href="#" class="footer__title-link">Услуги</a></div>
                    <div class="flex-container">
                        <div class="col-desk-50 d-tab-none">
                ...
                <div class="col-desk-25 d-tab-none d-none">
                ...
                <div class="col-desk-25 col-tab-100">
                    <div class="footer_title d-none"><a href="#" class="footer__title-link">Контакты</a></div>
                    <div class="footer__nav">
